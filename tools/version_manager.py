...
def backup(base_dir: str, slug: str):
    ...
    for filename in ["memory.md", "persona.md", "SKILL.md", "meta.json"]:
...
def main():
    parser = argparse.ArgumentParser(description="导师 Skill 版本管理器")
    parser.add_argument("--action", required=True, choices=["backup", "rollback", "list"])
    parser.add_argument("--slug", required=True, help="导师代号")
