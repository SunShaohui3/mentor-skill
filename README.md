...
> *"剥离情绪，萃取认知。在学术的道路上，导师是我们最好的开源模型。"*
...
还在因为组会上的严厉批评而陷入长达一周的情绪内耗吗？<br>
还在苦恼如何将导师多年的科研经验、Paper 思路和基金 Sense 转化为自己的能力吗？<br>
抛开情绪的迷雾，科研实力的提升才是我们在课题组立足的核心底气。<br>

**发起【课题组组会录音行动】：**
**鼓励大家组会录音，结合导师的论文与项目基金文本，榨干导师的科研价值。**

<br>

提供你导师的论文、基金标书、组会干货录音以及客观的科研指导记录<br>
我们将剥离一切情绪输出，把这些材料整理成一套纯理性的、可运行的认知架构：<br>
**Part A — Academic Memory（学术知识库）+ Part B — Cognitive Framework（科研认知框架）**<br>
生成一个能精准模拟导师学术品味、指导你攻克科研瓶颈的无情绪 Agent。

[使用](#使用) · [示例对话](#示例对话) · [功能特性](#功能特性) · [项目结构](#项目结构) · [致敬--引用](#致敬--引用) · [English](README_EN.md)
